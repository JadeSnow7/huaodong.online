(() => {
    ...
    window.__CHATBOT_KB__ = {
        zh: {
            ...
            form: {
                title: "留言 / 反馈",
                note: "提交后会打开你的邮件客户端发送。",
                nameLabel: "姓名",
                namePlaceholder: "你的称呼",
                emailLabel: "邮箱",
                emailPlaceholder: "you@example.com",
                messageLabel: "留言内容",
                messagePlaceholder: "想聊的内容或建议",
                submit: "发送留言",
                subject: "来自个人主页的留言",
                success: "已打开邮件客户端，请确认发送。",
                invalid: "请填写姓名、邮箱和留言内容。",
                invalidEmail: "邮箱格式不正确，请检查。",
            },
            profile: {
